    ...
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-800 dark:text-slate-100 transition-colors duration-200 py-8 md:py-12">
      ...
      <div className="container mx-auto px-4 max-w-7xl mb-10">
        ...
        <div className="bg-white dark:bg-slate-900 p-6 md:p-8 rounded-3xl shadow-sm border border-slate-100 dark:border-slate-800 mb-8 transition-colors">
          ...
          <form method="GET" action="/mobiles" className="space-y-4">
            {/* Top row: Search Bar */}
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <button 
                type="submit" 
                className="bg-teal-600 hover:bg-teal-500 active:bg-teal-700 transition-all text-white px-8 py-3.5 rounded-2xl font-bold text-sm shadow-md shadow-teal-600/10 cursor-pointer shrink-0"
              >
                بحث ذكي
              </button>
            </div>

            {/* Bottom row: Filters - auto-submit on change */}
            <div className="grid grid-cols-1 sm:grid-cols-4 gap-3 pt-2 border-t border-slate-100 dark:border-slate-800">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <select 
                  ...
                  className="filter-select w-full px-3 py-2.5 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl outline-none focus:border-teal-500 focus:bg-white dark:focus:bg-slate-900 text-xs font-medium text-slate-700 dark:text-slate-300 transition-all cursor-pointer"
                >
